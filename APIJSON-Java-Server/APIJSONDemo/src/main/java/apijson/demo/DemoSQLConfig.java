...
public class DemoSQLConfig extends APIJSONSQLConfig {
	...
	static {
		...
		DEFAULT_SCHEMA = "tencent_apijson";  // TODO 默认数据库名/模式，改成你自己的，默认情况是 MySQL: sys, PostgreSQL: public, SQL Server: dbo, Oracle:
	...
	public String getDBVersion() {
		return "5.7.35";  // "8.0.11";  // TODO 改成你自己的 MySQL 或 PostgreSQL 数据库版本号  // MYSQL 8 和 7 使用的 JDBC 配置不一样
	}
